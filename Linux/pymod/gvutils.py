###############################################################################
# $Id: gvutils.py,v 1.24 2003/08/28 19:50:18 warmerda Exp $
#
# Project:  OpenEV
...
def XMLInstantiate( node, parent ):
    import gdal
    ...
    try:
        ...
        instance = func( node, parent )
        return instance
    except:
        print 'Failed to instantiate %s:%s' % (module, classname)       
        raise
        return None
