/******************************************************************************
 * $Id: gvshapefile.c,v 1.22 2007/06/01 19:17:26 warmerda Exp $
 *
 * Project:  OpenEV
 ...
 *
 * $Log: gvshapefile.c,v $
 * Revision 1.22  2007/06/01 19:17:26  warmerda
 * rewind shapes before writing
 *
...
/* -------------------------------------------------------------------- */
    ...
    for( shape_index = 0; shape_index < shape_count; shape_index++ )
    {
        ...
        SHPRewindObject( shp_handle, shp_object );
