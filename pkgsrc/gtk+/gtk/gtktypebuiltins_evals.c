...
static const GtkEnumValue _gtk_private_flags_values[] = {
  ...
  { PRIVATE_GTK_IS_OFFSCREEN, "PRIVATE_GTK_IS_OFFSCREEN", "is-offscreen" },
  { PRIVATE_GTK_FULLDRAW_PENDING, "PRIVATE_GTK_FULLDRAW_PENDING", "fulldraw-pending" },
  { 0, NULL, NULL }
};
...
static const GtkEnumValue _gdk_drawable_type_values[] = {
  { GDK_WINDOW_ROOT, "GDK_WINDOW_ROOT", "window-root" },
  { GDK_WINDOW_TOPLEVEL, "GDK_WINDOW_TOPLEVEL", "window-toplevel" },
  { GDK_WINDOW_CHILD, "GDK_WINDOW_CHILD", "window-child" },
  { GDK_WINDOW_DIALOG, "GDK_WINDOW_DIALOG", "window-dialog" },
  { GDK_WINDOW_TEMP, "GDK_WINDOW_TEMP", "window-temp" },
  { GDK_DRAWABLE_PIXMAP, "GDK_DRAWABLE_PIXMAP", "drawable-pixmap" },
  { GDK_WINDOW_FOREIGN, "GDK_WINDOW_FOREIGN", "window-foreign" },
  { 0, NULL, NULL }
};
...
static const GtkEnumValue _gdk_scroll_direction_values[] = {
...
static const GtkEnumValue _gdk_image_type_values[] = {
  ...
  { GDK_IMAGE_SHARED_PIXMAP, "GDK_IMAGE_SHARED_PIXMAP", "shared-pixmap" },
  { 0, NULL, NULL }
};
