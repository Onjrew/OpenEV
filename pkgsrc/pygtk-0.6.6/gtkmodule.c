...
void init_gtk() {
     ...
     PyGtk_Type.ob_type = &PyType_Type;
     PyGtkAccelGroup_Type.ob_type = &PyType_Type;
     PyGtkStyleHelper_Type.ob_type = &PyType_Type;
     PyGtkStyle_Type.ob_type = &PyType_Type;
     PyGdkFont_Type.ob_type = &PyType_Type;
     ...
     PyGdkDragContext_Type.ob_type = &PyType_Type;
